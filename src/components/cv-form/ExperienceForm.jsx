        ...
        >
          <div className="flex justify-between items-center">
            <h4 className="font-medium text-cv-text-main flex items-center gap-2">
              <Briefcase className="w-5 h-5 text-cv-primary-500" />
              Experiencia {index + 1}
            </h4>
            {data.length > 1 && (
              <button
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              <label className="text-sm font-medium text-cv-text-main mb-1 block">Empresa</label>
              <input
                type="text"
                value={exp.company}
            ...
            <div>
              <label className="text-sm font-medium text-cv-text-main mb-1 block">Puesto</label>
              <input
                type="text"
                value={exp.position}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-cv-primary-200 rounded-lg focus:ring-2 focus:ring-cv-primary-500 focus:border-transparent outline-none transition-all disabled:bg-cv-bg-light disabled:cursor-not-allowed"
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-4 h-4 text-cv-primary-600 border-cv-primary-200 rounded focus:ring-cv-primary-500"
              />
              <label htmlFor={`current-${exp.id}`} className="text-sm text-cv-text-main">
                Trabajo actual
              </label>
            </div>
